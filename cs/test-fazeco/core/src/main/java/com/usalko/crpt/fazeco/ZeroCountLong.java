 ...
 * В случае типов long
 */
public class ZeroCountLong implements ZeroCounter<Long> {
     ...
     * @return Long который возвращает количество нулей в значении факториала
     * @throws InvalidNumberException выбрасывается в случае отрицательного значения
     */
    @Override
    public Long count(Long number) throws InvalidNumberException {
